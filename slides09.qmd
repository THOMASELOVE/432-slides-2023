...
We had 262 variables in our original seven tibbles, but that counts the SEQN variable seven times, and we only have it once in our `nh_merge` tibble.

Now, which of these 256 variables are we actually going to use?

## Variables We'll Use Today
...
LBXSCLSI | Serum Chloride (mmol/L) | BIOPRO_G
